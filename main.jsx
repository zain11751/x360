  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-4">
        ...
        {canEdit && <button onClick={openNew} className="flex items-center gap-1 px-3 py-1.5 bg-blue-600 text-white rounded text-sm font-semibold hover:bg-blue-700"><Plus size={16}/>New Expense</button>}
      </div>
